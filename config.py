...
YTPROXY_URL = getenv("YTPROXY_URL", 'https://teaminflex.xyz') ## xBit Music Endpoint.
YT_API_KEY = getenv("YT_API_KEY" , 'INFLEX77137628D') ## Your API key like: xbit_10000000xx0233 Get from  https://t.me/tgmusic_apibot
