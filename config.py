...
YTPROXY_URL = getenv("YTPROXY_URL", 'https://t.me/NickApiBot') ## xBit Music Endpoint.
YT_API_KEY = getenv("YT_API_KEY" , 'NICK_OWNER_60ZL') ## Your API key like: xbit_10000000xx0233 Get from  https://t.me/tgmusic_apibot
